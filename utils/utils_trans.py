from models.model_trans import Transformer
...
# Load Tokenizers
tokenizer_inputs = load_tokenizer('../artifacts/trans_model/tokenizer_inputs.pkl')
tokenizer_outputs = load_tokenizer('../artifacts/trans_model/tokenizer_outputs.pkl')
